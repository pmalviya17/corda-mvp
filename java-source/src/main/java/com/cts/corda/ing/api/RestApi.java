...
import com.cts.corda.ing.flow.SecurityIssueFlow;
import com.cts.corda.ing.flow.buy.APBuyFlow;
import com.cts.corda.ing.flow.sell.APSellFlow;
...
public class RestApi {
    ...
    public Response selfIssueProductStock(@QueryParam(value = "quantity") int quantity, @QueryParam(value = "securityName") String securityName) throws ExecutionException, InterruptedException {
