package com.cts.corda.ing.plugin;


import com.cts.corda.ing.api.INGRestApi;
...
public class ExamplePlugin implements WebServerPluginRegistry {
     ...
     */
    private final List<Function<CordaRPCOps, ?>> webApis = ImmutableList.of(INGRestApi::new);
