...
public abstract class AbstractTwoPartyFlow extends FlowLogic<SignedTransaction> {
    ...
    protected ProductTradeState productTradeState;
    Party otherParty;
    Party myself;
    ...
    protected abstract ProductTradeState getProductTradeState();
    ...
    abstract protected void respondToInitiator(ProductTradeState productTradeState);

    protected ProductTradeState callNextPartyFlow(ProductTradeState productTradeState) throws FlowException {
