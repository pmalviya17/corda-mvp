package com.cts.corda.ing.flow.sell;

import co.paralleluniverse.fibers.Suspendable;
import com.cts.corda.ing.contract.SecurityStock;
import com.cts.corda.ing.contract.SellContract;
import com.cts.corda.ing.flow.buy.APBuyCompletionFlow;
...
import static com.cts.corda.ing.contract.SellContract.SELL_SECURITY_CONTRACT_ID;
...
public class ApSellSettleFlow extends FlowLogic<SignedTransaction> {
    ...
    public SignedTransaction call() throws FlowException {
        ...
        List<StateAndRef<SecurityStock.State>> productTradeStatesQueryResp = getServiceHub().getVaultService().queryBy(SecurityStock.State.class).getStates();
        ...
        SecurityStock.State productTradeState1 = new SecurityStock.State(issuer1, getOurIdentity(), securityState.getSecurityName(), -securityState.getQuantity());
        ...
        final TransactionBuilder txBuilder1 = new TransactionBuilder(notary).withItems(new StateAndContract(productTradeState1, SECURITY_STOCK_CONTRACT), txCommand1);
        ...
        SecurityStock.State productTradeState = new SecurityStock.State(issuer, flowSession.getCounterparty(), securityState.getSecurityName(), securityState.getQuantity());
        ...
        System.out.println("Inside ProductIssue flow finalize tx11");
